...
const LightRays: React.FC<LightRaysProps> = ({
  raysOrigin = "top-center" as OriginType,
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const updatePlacement = () => {
        ...
        const { anchor, dir } = getAnchorAndDir(raysOrigin as OriginType, w, h);
  ...
  useEffect(() => {
    ...
    const { clientWidth: wCSS, clientHeight: hCSS } = containerRef.current;
    const dpr = renderer.dpr;
    const { anchor, dir } = getAnchorAndDir(raysOrigin as OriginType, wCSS * dpr, hCSS * dpr);
