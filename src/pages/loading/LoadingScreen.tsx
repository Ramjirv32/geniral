...
// We'll use a direct path to the logo in the root directory
...
function LoadingScreen() {
  ...
  useEffect(() => {
    // Fade in logo animation immediately
    const logoTimer = setTimeout(() => {
      setLogoOpacity(1)
    }, 300)

    // Show tagline just slightly after logo appears (300ms + 200ms = 500ms)
    ...
    // Navigate to main page after giving enough time to see all animations
    const navigationTimer = setTimeout(() => {
      navigate('/')
    }, 5000) // Reduced back to 5 seconds since everything appears faster
